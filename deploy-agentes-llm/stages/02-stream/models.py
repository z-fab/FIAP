"""
Schemas Pydantic para os endpoints síncrono e streaming — Stage 02.

Define os contratos de entrada e saída da API REST, incluindo o modelo
de evento SSE utilizado pelo endpoint /stream.
"""
